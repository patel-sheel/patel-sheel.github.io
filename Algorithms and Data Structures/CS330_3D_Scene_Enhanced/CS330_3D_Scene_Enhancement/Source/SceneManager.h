...
public:
	...
	void MakeTreeLeft(float, float, float, float);
	void MakeTreeRight(float, float, float, float);
	void MakeTreeCenter(float, float, float);
	void MakeMountain(float, float, float, float);
	void MakeEgg(float, float, float);
	void MakeKey(float, float, float);
	void MakePlatform(float, float, float, float);
